# **************************************************************************** #
# Purpose: Creating a shopping list for my beautiful lovely gf
# If only I was rich, id buy the whole world for you ;)
# Author: Njoki Njuki
# Date: 02.08.2024
# Last edit: 02.09.2025 (to publish in my website)
# **************************************************************************** #

# Set seed for reproducibility (optional)
set.seed(123)

# Create a list of gift ideas with emojis and links
gift_ideas <- c(
  # Books-related gifts
...
selected_gift <- sample(gift_ideas, 4)

# Print the selected gift
cat("Gift for my baby:", selected_gift, "\n")
